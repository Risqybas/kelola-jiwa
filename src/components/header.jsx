...
function Header() {
  ...
  return (
    <div className="w-full h-14 bg-surface bg-white/5 backdrop-blur-md sticky top-0 text-on-surface flex items-center px-5 shadow-[0_20px_20px_-5px_rgba(74,101,78,0.08)] z-50">
